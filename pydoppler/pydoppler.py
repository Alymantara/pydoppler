...
#        f.write(str(len(self.flux))+" "+str(self.nbins)+" "+str(self.lam0)+'\n')
    ...
    def Dopmap(self,dopout = 'dop.out',cmaps = cm.Greys_r,
        ...
        if colorbar:
            ...
            cbar.set_norm(mynormalize.MyNormalize(vmin=limits[0],vmax=limits[1],
                                                  stretch='log'))
    ...
    def Reco(self, cmaps=plt.cm.binary, limits=None, colorbar=True):
        ...
        if colorbar:
            ...
            cbar2.set_norm(mynormalize.MyNormalize(vmin=np.median(dm/np.nanmax(dm))*0.8,
        ...
        if colorbar:
            ...
            cbar3.set_norm(mynormalize.MyNormalize(vmin=np.median(dmr/np.nanmax(dmr))*0.8,
